  ...
  <body>
    ...
    <div class="form_div">
      ...
      <form class="form" action="Data_Entry.php" method="post">
        ...
        <input type="text" id="serial" name="serial_no" placeholder="123"/>
        <label for="regno">Registration Number</label>
        <input type="text" id="regno" name="regno" placeholder="202020202" />
        <label for="name">Name</label>
        <input type="text" id="name" name="Name" placeholder="Alexa Siri" />
        <label for="sub1">Subject 1</label>
        <input type="number" id="sub1" name="sub1" placeholder="33" />
        <label for="sub2">Subject 2</label>
        <input type="number" id="sub2" name="sub2" placeholder="33" />
        <label for="sub3">Subject 3</label>
        <input type="number" id="sub3" name="sub3" placeholder="33" />
